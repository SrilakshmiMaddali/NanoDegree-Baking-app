...
import static bakingapp.sm.com.bakingapp.userInterface.MainActivity.SELECTED_INDEX;
import static bakingapp.sm.com.bakingapp.userInterface.MainActivity.SELECTED_STEPS;
...
public class RecipeStepDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recipeStepDetailTextview.setText(steps.get(selectedIndex).getDescription());
        ...
        recipePrevStep.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (steps.get(selectedIndex).getId() > 0) {
                    ...
                    clickListener.onRecipeStepDetailItemClick(steps, steps.get(selectedIndex).getId() - 1,recipeName);
                }
                else {
    ...
    private void initializePlayer(Uri mediaUri) {
        ...
        if(exoPlayer == null) {
            ...
            String userAgent = Util.getUserAgent(getContext(), "Baking-World");
